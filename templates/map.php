    ...
    <div id="header">
      <div class="wrap group">
        ...
        <ul class="nav global">
          ...
          <li><a href="<?php echo isset($base_url) ? $base_url : ''; ?>/maps/lwc" data-map-link="lwc">LWC</a></li>
          <li><a href="<?php echo isset($base_url) ? $base_url : ''; ?>/maps/lec" data-map-link="lec">LEC</a></li>
        </ul>
      </div>
    </div>
